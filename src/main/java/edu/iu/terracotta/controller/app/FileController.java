...
@Slf4j
@Controller
@RequestMapping(value = FileController.REQUEST_ROOT, produces = MediaType.APPLICATION_JSON_VALUE)
public class FileController {
    ...
    @PostMapping("/files")
    public ResponseEntity<List<FileInfoDto>> uploadFiles(@PathVariable long experimentId,
    ...
    @GetMapping("/files")
    public ResponseEntity<List<FileInfoDto>> getFilesByExperiment(@PathVariable long experimentId,
                                                                  HttpServletRequest req)
            throws ExperimentNotMatchingException, BadTokenException {
    ...
    @GetMapping("/consent")
    public ResponseEntity<Resource> getConsent(@PathVariable long experimentId,
                                                 HttpServletRequest req)
            throws ExperimentNotMatchingException, BadTokenException {
        SecuredInfo securedInfo = apijwtService.extractValues(req,false);
        apijwtService.experimentAllowed(securedInfo, experimentId);
    ...
    public ResponseEntity<Void> deleteConsent(@PathVariable long experimentId,
                                           HttpServletRequest req)
            throws ExperimentNotMatchingException, BadTokenException {
        SecuredInfo securedInfo = apijwtService.extractValues(req,false);
        apijwtService.experimentAllowed(securedInfo, experimentId);
