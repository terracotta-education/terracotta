...
public interface TreatmentPreviewService {
    ...
    TreatmentPreviewDto getTreatmentPreview(UUID uuid, long treatmentId, long experimentId, long conditionId, String ownerId) throws TreatmentNotMatchingException, AssessmentNotMatchingException;
