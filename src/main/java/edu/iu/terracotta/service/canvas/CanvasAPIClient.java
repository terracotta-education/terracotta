...
public interface CanvasAPIClient {
    ...
    // List<Submission> listSubmissionsForGivenUser(LtiUserEntity apiUser, Integer
    // assignmentId, String canvasCourseId,
    ...
    // Optional<Progress> postSubmission(LtiUserEntity apiUser,
    // edu.iu.terracotta.model.app.Submission submission,
    ...
    // * @throws IOException
    // */
    // Optional<Progress> postConsentSubmission(LtiUserEntity apiUser, Participant
    // participant)
    // throws CanvasApiException, IOException;
}
