...
/**
 * Thrown if Brightspace returns a 401 response with a WWW-Authenticate header present.
 ...
 * is invalid.
 */
public class InvalidOauthTokenException extends BrightspaceException {
