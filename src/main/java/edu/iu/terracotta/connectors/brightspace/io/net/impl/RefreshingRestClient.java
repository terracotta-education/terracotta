...
/**
 * This class wraps SimpleRestClient. It provides functionality to catch OAuth errors that may be the result of an expired access
 * token that needs to be refreshed using the user's refresh token. After refreshing the token it retries the request once. If it
