          ...
          >
            ...
            <tbody>
              ...
              >
                ...
                <td
                  v-if="participantScoreList.length"
                >
                  <v-text-field
...
export default {
  ...
  computed: {
    ...
    exitDisabled() {
      return this.outcome.title.length<1 ||
        this.outcome.title.length > 255 ||
        this.outcome.maxPoints < 0 ||
        this.outcomeScores
          .filter((os) => os.outcomeId === this.outcomeId)
          .some((score) => score.scoreNumeric > this.outcome.maxPoints);
    },
    exposureId() {
    ...
    participantFilteredList() {
      ...
      return  soratableNameAddedParticipants
        .sort((a, b)=> (a.user.sortableName .toLowerCase() > b.user.sortableName.toLowerCase()) ? 1 : -1);
    }
  },
  methods: {
    ...mapActions({
