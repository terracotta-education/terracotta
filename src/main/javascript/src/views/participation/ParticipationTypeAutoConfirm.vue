<template>
	<div>
		...
		<br>
		<router-link class="plain-link" :to="{name: 'ExperimentParticipationSummary'}">No, I want to create a consent assignment instead</router-link>
	</div>
</template>
...
export default {
	...
	methods: {
		...
		setType() {
			...
			// this.$router.push({name:'ExperimentParticipationSummary', params:{experiment: this.experiment.experiment_id}})
		}
	}
}
</script>
