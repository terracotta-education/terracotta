...
public class BaseRepositoryTest extends BaseModelTest {
    ...
    public void setup() {
        try {
            ...
            when(experimentImportRepository.findAllByOwner_UserKeyAndContext_ContextIdAndStatusIn(anyString(), anyLong(), anyList())).thenReturn(Collections.singletonList(experimentImport));
            when(experimentImportRepository.findAllByUpdatedAtLessThanOrStatusIn(any(Timestamp.class), anyList())).thenReturn(Collections.singletonList(experimentImport));
            ...
            when(submissionRepository.findByParticipant_Id(anyLong())).thenReturn(Collections.singletonList(submission));
