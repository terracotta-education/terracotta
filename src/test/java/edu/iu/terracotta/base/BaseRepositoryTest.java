...
public class BaseRepositoryTest extends BaseModelTest {
    ...
    @Mock protected ExperimentImportErrorRepository experimentImportErrorRepository;
    ...
    @Mock protected LtiNonceRepository ltiNonceRepository;
    ...
    public void setup() {
        try {
            ...
            when(apiScopeRepository.findAllByFeatures_Id(anyLong())).thenReturn(List.of(apiScope));
            when(apiScopeRepository.findAllByLmsConnectorAndFeatures_Type(any(), any())).thenReturn(List.of(apiScope));
            when(apiScopeRepository.findDistinctByFeatures_PlatformDeployments_KeyId(anyLong())).thenReturn(List.of(apiScope));
            ...
            when(assignmentRepository.findByExposure_ExposureIdAndSoftDeletedOrderByAssignmentOrderAsc(anyLong(), anyBoolean())).thenReturn(List.of(assignment));
            ...
            when(experimentImportErrorRepository.findById(anyLong())).thenReturn(Optional.of(experimentImportError));
            when(experimentImportRepository.findById(anyLong())).thenReturn(Optional.of(experimentImport));
            when(experimentImportRepository.save(any(ExperimentImport.class))).thenReturn(experimentImport);
            when(experimentImportRepository.findByUuid(any(UUID.class))).thenReturn(Optional.of(experimentImport));
            when(experimentImportRepository.findAllByOwner_UserKeyAndContext_ContextIdAndStatusIn(anyString(), anyLong(), anyList())).thenReturn(List.of(experimentImport));
            ...
            when(experimentRepository.findAllByLtiContextEntity_ContextId(anyLong())).thenReturn(List.of(experiment));
            ...
            when(integrationClientRepository.getAllByEnabled(anyBoolean())).thenReturn(List.of(integrationClient));
            ...
            when(integrationTokenLogRepository.findAllByIntegrationToken_Id(anyLong())).thenReturn(List.of(integrationTokenLog));
            ...
            when(obsoleteAssignmentRepository.findAllByContext_ContextId(anyLong())).thenReturn(List.of(obsoleteAssignment));
            ...
            when(participantRepository.countByExperiment_ExperimentIdGroupByGroup(anyLong())).thenReturn(List.of(groupParticipantCount));
            when(participantRepository.findByExperiment_ExperimentId(anyLong())).thenReturn(List.of(participant));
            ...
            when(treatmentRepository.findByAssignment_AssignmentIdInOrderByCondition_ConditionIdAsc(any())).thenReturn(List.of(treatment));
            ...
            when(treatmentRepository.findByCondition_Experiment_ExperimentIdOrderByCondition_ConditionIdAsc(anyLong())).thenReturn(List.of(treatment));
