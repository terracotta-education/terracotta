...
public class BaseServiceTest extends BaseRepositoryTest {
    ...
    @Mock protected AssignmentWriterService brightspaceAssignmentWriterService;
    @Mock protected AwsService awsService;
    @Mock protected BrightspaceAdvantageAgsServiceImpl brightspaceAdvantageAgsService;
    @Mock protected BrightspaceApiFactory brightspaceApiFactory;
    @Mock protected BrightspaceLmsOAuthServiceImpl brightspaceLmsOAuthService;
    @Mock protected BrightspaceLmsUtilsImpl brightspaceLmsUtils;
    ...
    @Mock protected ComponentUtils componentUtils;
    ...
    @Mock protected ExperimentImportErrorService experimentImportErrorService;
    @Mock protected ExperimentImportService experimentImportService;
    ...
    @Mock protected LmsUtils lmsUtils;
    ...
    public void setup() {
        try {
            ...
            when(advantageAgsService.getToken(any(LtiAgsScope.class), any(PlatformDeployment.class))).thenReturn(ltiToken);
            ...
            when(apiClient.listAssignments(any(LtiUserEntity.class), any(LtiContextEntity.class))).thenReturn(List.of(lmsAssignment));
            when(apiClient.listAssignments(any(LtiUserEntity.class), any(Experiment.class))).thenReturn(List.of(lmsAssignment));
            when(apiClient.listSubmissions(any(LtiUserEntity.class), anyString(), anyString())).thenReturn(List.of(lmsSubmission));
            ...
            when(assignmentService.getAllAssignmentsForLmsCourse(any(SecuredInfo.class))).thenReturn(List.of(lmsAssignment));
            ...
            when(brightspaceAssignmentWriterService.createAssignment(anyString(), any(edu.iu.terracotta.connectors.brightspace.io.model.Assignment.class))).thenReturn(Optional.of(brightspaceAssignmentExtended));
            when(brightspaceLmsOAuthService.isConfigured(any(PlatformDeployment.class))).thenReturn(true);
            when(brightspaceLmsOAuthService.getAccessToken(any(LtiUserEntity.class))).thenReturn(apiTokenEntity);
            when(canvasAdvantageAgsService.getLineItems(any(LtiToken.class), any(LtiContextEntity.class))).thenReturn(lineItems);
            when(canvasAdvantageAgsService.getToken(any(LtiAgsScope.class), any(PlatformDeployment.class))).thenReturn(ltiToken);
            ...
            when(canvasApiClient.listAssignments(any(LtiUserEntity.class), any(LtiContextEntity.class))).thenReturn(List.of(canvasAssignmentExtended));
            when(canvasApiClient.listAssignments(any(LtiUserEntity.class), any(Experiment.class))).thenReturn(List.of(canvasAssignmentExtended));
            when(canvasApiClient.listCoursesForUser(any(PlatformDeployment.class), anyString(), anyString())).thenReturn(List.of(canvasCourseExtended));
            when(canvasApiClient.listSubmissions(any(LtiUserEntity.class), anyString(), anyString())).thenReturn(List.of(canvasSubmissionExtended));
            ...
            when(experimentImportService.acknowledge(any(ExperimentImport.class), any(ExperimentImportStatus.class))).thenReturn(importDto);
            ...
            when(integrationClientService.getAll()).thenReturn(List.of(integrationClient));
            when(integrationClientService.toDto(any(IntegrationClient.class), anyString())).thenReturn(integrationClientDto);
            when(integrationClientService.toDto(anyList(), anyString())).thenReturn(List.of(integrationClientDto));
            ...
            when(integrationService.toDto(anyList())).thenReturn(List.of(integrationDto));
